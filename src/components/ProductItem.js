...
function ProductItem (props) {
    ...
    return (
        ...
        <div className="item__data">
            ...
            <p className="item__percnt"><span className="item__percnt--num">{percnt}</span><span className="item__percnt--sign">&#37;</span> stockout</p>
            <div className="item__bar"><div className="item__bar--progress" style={{ width : `${percnt}%` }}></div></div>
            <p className="item__coverage"><span className={`item__coverage--span ${coverageClass}`}>{coverage}</span> wh coverage</p>
        </div>
        </>
    )
}
